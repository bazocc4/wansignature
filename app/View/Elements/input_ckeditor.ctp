...
<div class="control-group" <?php echo (empty($display)?'':'style="display:none"'); ?>>            
	...
	<div class="controls">
		...
		?>
		<textarea rows="5" <?php echo $required; ?> type="text" placeholder="<?php echo $placeholder; ?>" class="large ckeditor <?php echo $shortkey; ?>" name="data[<?php echo $model; ?>][<?php echo $counter; ?>][value]"><?php echo (isset($_POST['data'][$model][$counter]['value'])?$_POST['data'][$model][$counter]['value']:$value); ?></textarea>
	</div>
