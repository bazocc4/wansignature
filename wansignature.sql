...
INSERT INTO `cms_type_metas` VALUES (498,14,'form-carat_4','','text','','Kadar carat DIAMOND pada produk ini.');
INSERT INTO `cms_type_metas` VALUES (499,14,'form-gold_carat','','text','','Kadar carat GOLD pada produk ini.');
INSERT INTO `cms_type_metas` VALUES (500,14,'form-gold_weight','','text','','Berat emas yg terkandung pada produk (gram).');
INSERT INTO `cms_type_metas` VALUES (501,14,'form-item_ref_code','','text','','Item reference code.');
INSERT INTO `cms_type_metas` VALUES (502,14,'form-item_ref_code_x2','','text','','Item reference code (X2)');
INSERT INTO `cms_type_metas` VALUES (503,14,'form-vendor','','browse','','Pihak vendor yang menyediakan produk ini.');
INSERT INTO `cms_type_metas` VALUES (504,14,'form-vendor_item_code','','text','','Kode produk asal dari pihak vendor.');
INSERT INTO `cms_type_metas` VALUES (505,14,'form-vendor_invoice_code','','text','','Kode invoice dari pihak vendor.');
INSERT INTO `cms_type_metas` VALUES (506,14,'form-vendor_invoice_date','','datepicker','','Purchase date from vendor.');
INSERT INTO `cms_type_metas` VALUES (507,14,'form-vendor_status','','text','','Product status with vendor (Sold / Credit / Consignment / Return / Syute / etc.)');
INSERT INTO `cms_type_metas` VALUES (508,14,'form-vendor_note','','text','','Additional information for this vendor invoice.');
INSERT INTO `cms_type_metas` VALUES (509,14,'form-vendor_currency','USD\r\nHKD','radio','not_empty|','Vendor Price in USD / HKD.');
INSERT INTO `cms_type_metas` VALUES (510,14,'form-vendor_barcode','','text','is_numeric|','Vendor original price.');
INSERT INTO `cms_type_metas` VALUES (511,14,'form-vendor_x','','text','is_numeric|','Vendor capital X for calculating price.');
INSERT INTO `cms_type_metas` VALUES (512,14,'form-vendor_usd','','text','is_numeric|','Vendor USD price result.');
INSERT INTO `cms_type_metas` VALUES (513,14,'form-vendor_hkd','','text','is_numeric|','Vendor HKD price result.');
INSERT INTO `cms_type_metas` VALUES (514,14,'form-report_date','','datepicker','','');
INSERT INTO `cms_type_metas` VALUES (515,14,'form-report_type','SR\r\nRR','radio','not_empty|','Sold Report / Return Report.');
INSERT INTO `cms_type_metas` VALUES (516,14,'form-temp_report','','text','','Temporary report date / notes.');
INSERT INTO `cms_type_metas` VALUES (517,14,'form-return_date','','datepicker','','When this product returned to vendor.');
INSERT INTO `cms_type_metas` VALUES (518,14,'form-return_detail','','textarea','','Return information detail.');
INSERT INTO `cms_type_metas` VALUES (519,14,'form-omzet','','text','','Produk masuk omzet mana dan kapan.');
INSERT INTO `cms_type_metas` VALUES (520,14,'form-client_invoice_code','','text','','Kode invoice untuk pihak client.');
INSERT INTO `cms_type_metas` VALUES (521,14,'form-client_invoice_date','','datepicker','','Sold date to client.');
INSERT INTO `cms_type_metas` VALUES (522,14,'form-client','','browse','','Who purchase this product.');
INSERT INTO `cms_type_metas` VALUES (523,14,'form-client_x','','text','is_numeric|','Client sell X value.');
INSERT INTO `cms_type_metas` VALUES (524,14,'form-wholesaler','','browse','','The wholesaler of selected client.');
...
INSERT INTO `cms_type_metas` VALUES (582,17,'form-payment_credit_card','','text','','Payment from client using credit card.');
INSERT INTO `cms_type_metas` VALUES (525,14,'form-wholesaler_x','','text','is_numeric|','Client wholesaler sell X value.');
INSERT INTO `cms_type_metas` VALUES (526,14,'form-total_sold_price','','text','','Total sold price to client in USD.');
INSERT INTO `cms_type_metas` VALUES (527,14,'form-sold_price_usd','','text','','Sold price paid in USD.');
INSERT INTO `cms_type_metas` VALUES (528,14,'form-sold_price_rp','','text','is_numeric|','Sold price paid in IDR.');
INSERT INTO `cms_type_metas` VALUES (529,14,'form-rp_rate','','text','is_numeric|','IDR rate to $1 USD.');
INSERT INTO `cms_type_metas` VALUES (530,14,'form-client_outstanding','','textarea','','');
INSERT INTO `cms_type_metas` VALUES (531,14,'form-payment_credit_card','','text','','Payment from client using credit card.');
INSERT INTO `cms_type_metas` VALUES (532,14,'form-payment_cicilan','','text','','Payment from client using bank installment (HSBC / PERMATA / CITI) 3 / 6 / 12 months.');
INSERT INTO `cms_type_metas` VALUES (533,14,'form-payment_cash','','text','','Payment from client using cash / bank transfer / debit card.');
...
INSERT INTO `cms_type_metas` VALUES (567,17,'form-client_invoice_code','','text','','Kode invoice untuk pihak client.');
INSERT INTO `cms_type_metas` VALUES (568,17,'form-client_invoice_date','','datepicker','','Sold date to client.');
INSERT INTO `cms_type_metas` VALUES (569,17,'form-client','','browse','','Who purchase this product.');
INSERT INTO `cms_type_metas` VALUES (570,17,'form-wholesaler','','browse','','The wholesaler of selected client.');
INSERT INTO `cms_type_metas` VALUES (571,17,'form-client_invoice_pcs','','text','','Total pcs of jewelries sold on this client invoice.');
INSERT INTO `cms_type_metas` VALUES (572,17,'form-client_invoice_sold_110','','text','is_numeric|','Weight of <strong>SOLD 110</strong> on this client invoice (gram).');
INSERT INTO `cms_type_metas` VALUES (573,17,'form-client_invoice_x_110','','text','is_numeric|','<strong>X 110</strong> factor on this client invoice.');
INSERT INTO `cms_type_metas` VALUES (574,17,'form-client_invoice_sold_115','','text','is_numeric|','Weight of <strong>SOLD 115</strong> on this client invoice (gram).');
INSERT INTO `cms_type_metas` VALUES (575,17,'form-client_invoice_x_115','','text','is_numeric|','<strong>X 115</strong> factor on this client invoice.');
INSERT INTO `cms_type_metas` VALUES (576,17,'form-client_invoice_disc_return','','text','is_numeric|','Weight discount of return product on this client invoice (gram).');
INSERT INTO `cms_type_metas` VALUES (577,17,'form-gold_price','','text','is_numeric|','Current gold price per Gram (IDR).');
INSERT INTO `cms_type_metas` VALUES (578,17,'form-payment_ct_ld','','text','','Payment from client using CT (local material) & LD.');
INSERT INTO `cms_type_metas` VALUES (579,17,'form-payment_rosok','','text','','Payment from client using rosok item.');
INSERT INTO `cms_type_metas` VALUES (580,17,'form-payment_checks','','text','','Payment from client using bank checks.');
INSERT INTO `cms_type_metas` VALUES (581,17,'form-payment_cash','','text','','Payment from client using cash / bank transfer / debit card.');
INSERT INTO `cms_type_metas` VALUES (534,14,'form-payment_checks','','text','','Payment from client using bank checks.');
INSERT INTO `cms_type_metas` VALUES (535,14,'form-prev_sold_price','','text','','Previous sold price.');
INSERT INTO `cms_type_metas` VALUES (536,14,'form-prev_barcode','','text','','Previous barcode / price tag.');
INSERT INTO `cms_type_metas` VALUES (537,14,'form-prev_sold_note','','textarea','','Previous sold note for transaction history.');
INSERT INTO `cms_type_metas` VALUES (566,17,'form-product_status','','text','','Current product status (Stock / Sold / Consignment / Return / Changed / etc.)');
INSERT INTO `cms_type_metas` VALUES (565,17,'form-exhibition','','browse','','Exhibition di mana produk ini sedang dipamerkan.');
INSERT INTO `cms_type_metas` VALUES (564,17,'form-stock_date','','datepicker','','Kapan terakhir produk ini masuk ke WH sbg ready stock.');
INSERT INTO `cms_type_metas` VALUES (563,17,'form-warehouse','','browse','','Gudang di mana produk tersimpan.');
INSERT INTO `cms_type_metas` VALUES (562,17,'form-vendor_gr','','text','','Total weight of jewelries purchased on this vendor invoice.');
INSERT INTO `cms_type_metas` VALUES (561,17,'form-vendor_pcs','','text','is_numeric|','Total pcs of jewelries purchased on this vendor invoice.');
INSERT INTO `cms_type_metas` VALUES (560,17,'form-vendor_invoice_code','','text','','Kode invoice dari pihak vendor.');
INSERT INTO `cms_type_metas` VALUES (559,17,'form-vendor_x','','text','is_numeric|','Product X for this vendor.');
INSERT INTO `cms_type_metas` VALUES (558,17,'form-vendor','','browse','','Pihak vendor yang menyediakan produk ini.');
INSERT INTO `cms_type_metas` VALUES (557,17,'form-item_size','','text','is_numeric|','Ukuran produk cor.');
INSERT INTO `cms_type_metas` VALUES (556,17,'form-item_weight','','text','is_numeric|','Berat produk cor dalam satuan <strong>gram</strong>.');
INSERT INTO `cms_type_metas` VALUES (555,17,'form-product_brand','','browse','','Merk produk cor.');
INSERT INTO `cms_type_metas` VALUES (554,17,'form-product_type','','browse','','Tipe produk cor.');
...
INSERT INTO `cms_type_metas` VALUES (497,14,'form-carat_3','','text','','Kadar carat DIAMOND pada produk ini.');
INSERT INTO `cms_type_metas` VALUES (496,14,'form-carat_2','','text','','Kadar carat DIAMOND pada produk ini.');
INSERT INTO `cms_type_metas` VALUES (495,14,'form-carat_1','','text','','Kadar carat DIAMOND pada produk ini.');
INSERT INTO `cms_type_metas` VALUES (494,14,'form-exhibition','','browse','','Exhibition di mana produk ini sedang dipamerkan.');
INSERT INTO `cms_type_metas` VALUES (493,14,'form-stock_date','','datepicker','','Kapan terakhir produk ini masuk ke WH sbg ready stock.');
INSERT INTO `cms_type_metas` VALUES (492,14,'form-warehouse','','browse','','Gudang di mana produk tersimpan.');
INSERT INTO `cms_type_metas` VALUES (491,14,'form-status_in_wan','','text','','Current product status (Stock / Sold / Consignment / Return / Changed / etc.)');
...
INSERT INTO `cms_types` VALUES (14,'Diamond','diamond','Diamond product variations by WAN Signature.',0,0,'2015-06-04 15:43:39',1,'2015-06-08 13:55:43',1);
...
INSERT INTO `cms_types` VALUES (17,'Cor Jewelry','cor-jewelry','Cor jewelry produced by WAN Signature.',0,0,'2015-06-06 00:27:13',1,'2015-06-08 17:49:35',1);
